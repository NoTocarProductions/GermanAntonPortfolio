...
if (galleryImages) {
    galleryImages.forEach(function(item, index) {
        item.addEventListener('click', function() {
            ...
            newTxt.innerHTML = imgAlt + "<br>Barcelona City";
            newTxt.setAttribute("class", "imgTxt");

            newImg.onload = function() {
                console.log(newImg.getBoundingClientRect());
                let newImgRec = newImg.getBoundingClientRect();
                let distanceTop = newImgRec.top + (newImgRec.height/2);
                let distanceLeftArrow = newImgRec.left - 80;
                let distanceRightArrow = newImgRec.left + newImgRec.width + 20;
                ...
                btnPrevImg.style.cssText = "left: " + distanceLeftArrow + "px;" + "top: " + distanceTop + "px;";
                ...
                btnNextImg.style.cssText = "left: " + distanceRightArrow + "px;" + "top: " + distanceTop + "px;";

                let textAlt = document.querySelector(".imgTxt");
                textAlt.style.cssText = "top: " + newImgRec.top + "px;" + "left: " + distanceRightArrow + "px;";
            }
        })
    })
}
...
function changeImg(direction) {
    ...
    newImg.setAttribute("src", "https://source.unsplash.com/1600x900/" + setNewImgUrl);
    newImg.setAttribute("id", "current-image");
    nextTxt.innerHTML = thisImage.getAttribute("alt") + "<br>Barcelona City";
    ...
    nextBtn.style.cssText = "left: " + distanceRightArrow + "px;" + "top: " + distanceTop + "px;";

    let  prevBtn = document.querySelector(".img-btn-prev");
    prevBtn.style.cssText = "left: " + distanceLeftArrow + "px;" + "top: " + distanceTop + "px;";
