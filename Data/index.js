...
if(galleryImages) {
    galleryImages.forEach(function(image, index) { // "index" counts the current index of this array of images
        image.onclick = function() {
            let getElementCss = window.getComputedStyle(image); // get style stuff from the image from css
